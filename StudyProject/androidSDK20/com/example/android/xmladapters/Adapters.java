...
/**
 * <p>
 * This class can be used to load {@link android.widget.Adapter adapters} defined in XML resources. XML-defined adapters can be used to easily create adapters in your own
 * application or to pass adapters to other processes.
 * </p>
 * 
 * <h2>Types of adapters</h2>
 * <p>
 * Adapters defined using XML resources can only be one of the following supported types. Arbitrary adapters are not supported to guarantee the safety of the loaded code when
 * adapters are loaded across packages.
 * </p>
 * <ul>
 * <li><a href="#xml-cursor-adapter">Cursor adapter</a>: a cursor adapter can be used to display the content of a cursor, most often coming from a content provider</li>
 * </ul>
 * <p>
 * The complete XML format definition of each adapter type is available below.
 * </p>
 * 
 * <a name="xml-cursor-adapter"></a> <h2>Cursor adapter</h2>
 * <p>
 * A cursor adapter XML definition starts with the <a href="#xml-cursor-adapter-tag"><code>&lt;cursor-adapter /&gt;</code></a> tag and may contain one or more instances of the
 * following tags:
 * </p>
 * <ul>
 ...
 * </ul>
 * 
 * <a name="xml-cursor-adapter-tag"></a> <h3>&lt;cursor-adapter /&gt;</h3>
 * <p>
 * The <code>&lt;cursor-adapter /&gt;</code> element defines the beginning of the document and supports the following attributes:
 * </p>
 * <ul>
 * <li><code>android:layout</code>: Reference to the XML layout to be inflated for each item of the adapter. This attribute is mandatory.</li>
 * <li><code>android:selection</code>: Selection expression, used when the <code>android:uri</code> attribute is defined or when the adapter is loaded with
 * {@link Adapters#loadCursorAdapter(android.content.Context, int, String, Object[])}. This attribute is optional.</li>
 * <li><code>android:sortOrder</code>: Sort expression, used when the <code>android:uri</code> attribute is defined or when the adapter is loaded with
 * {@link Adapters#loadCursorAdapter(android.content.Context, int, String, Object[])}. This attribute is optional.</li>
 * <li><code>android:uri</code>: URI of the content provider to query to retrieve a cursor. Specifying this attribute is equivalent to calling
 * {@link Adapters#loadCursorAdapter(android.content.Context, int, String, Object[])}. If you call this method, the value of the XML attribute is ignored. This attribute is
 * optional.</li>
 * </ul>
 * <p>
 * In addition, you can specify one or more instances of <a href="#xml-cursor-adapter-select-tag"><code>&lt;select /&gt;</code></a> and <a href="#xml-cursor-adapter-bind-tag">
 * <code>&lt;bind /&gt;</code></a> tags as children of <code>&lt;cursor-adapter /&gt;</code>.
 * </p>
 * 
 * <a name="xml-cursor-adapter-select-tag"></a> <h3>&lt;select /&gt;</h3>
 * <p>
 * The <code>&lt;select /&gt;</code> tag is used to select columns from the cursor when doing the query. This can be very useful when using transformations in the
 * <code>&lt;bind /&gt;</code> elements. It can also be very useful if you are providing your own <a href="#xml-cursor-adapter-bind-data-types">binder</a> or <a
 * href="#xml-cursor-adapter-bind-data-types">transformation</a> classes. <code>&lt;select /&gt;</code> elements are ignored if you supply the cursor yourself.
 * </p>
 * <p>
 * The <code>&lt;select /&gt;</code> supports the following attributes:
 * </p>
 * <ul>
 * <li><code>android:column</code>: Name of the column to select in the cursor during the query operation</li>
 * </ul>
 * <p>
 * <strong>Note:</strong> The column named <code>_id</code> is always implicitly selected.
 * </p>
 * 
 * <a name="xml-cursor-adapter-bind-tag"></a> <h3>&lt;bind /&gt;</h3>
 * <p>
 * The <code>&lt;bind /&gt;</code> tag is used to bind a column from the cursor to a {@link android.view.View}. A column bound using this tag is automatically selected during the
 * query and a matching <a href="#xml-cursor-adapter-select-tag"><code>&lt;select /&gt;</code> tag is therefore not required.
 * </p>
 * 
 * <p>
 * Each binding is declared as a one to one matching but custom binder classes or special <a href="#xml-cursor-adapter-bind-data-transformation">data transformations</a> can allow
 * you to bind several columns to a single view. In this case you must use the <a href="#xml-cursor-adapter-select-tag"><code>&lt;select /&gt;</code> tag to make sure any required
 * column is part of the query.
 * </p>
 * 
 * <p>
 * The <code>&lt;bind /&gt;</code> tag supports the following attributes:
 * </p>
 * <ul>
 * <li><code>android:from</code>: The name of the column to bind from. This attribute is mandatory. Note that <code>@</code> which are not used to reference resources should be
 * backslash protected as in <code>\@</code>.</li>
 * <li><code>android:to</code>: The id of the view to bind to. This attribute is mandatory.</li>
 * <li><code>android:as</code>: The <a href="#xml-cursor-adapter-bind-data-types">data type</a> of the binding. This attribute is mandatory.</li>
 * </ul>
 * 
 * <p>
 * In addition, a <code>&lt;bind /&gt;</code> can contain zero or more instances of <a href="#xml-cursor-adapter-bind-data-transformation">data transformations</a> children tags.
 * </p>
 * 
 * <a name="xml-cursor-adapter-bind-data-types"></a> <h4>Binding data types</h4>
 * <p>
 ...
 * </p>
 * <ul>
 * <li><code>string</code>: The content of the column is interpreted as a string and must be bound to a {@link android.widget.TextView}</li>
 * <li><code>image</code>: The content of the column is interpreted as a blob describing an image and must be bound to an {@link android.widget.ImageView}</li>
 * <li><code>image-uri</code>: The content of the column is interpreted as a URI to an image and must be bound to an {@link android.widget.ImageView}</li>
 * <li><code>drawable</code>: The content of the column is interpreted as a resource id to a drawable and must be bound to an {@link android.widget.ImageView}</li>
 * <li><code>tag</code>: The content of the column is interpreted as a string and will be set as the tag (using {@link View#setTag(Object)} of the associated View. This can be used
 * to associate meta-data to your view, that can be used for instance by a listener.</li>
 * <li>A fully qualified class name: The name of a class corresponding to an implementation of {@link Adapters.CursorBinder}. Cursor binders can be used to provide bindings not
 * supported by default. Custom binders cannot be used with {@link android.content.Context#isRestricted() restricted contexts}, for instance in an application widget</li>
 * </ul>
 * 
 * <a name="xml-cursor-adapter-bind-transformation"></a> <h4>Binding transformations</h4>
 * <p>
 * When defining a data binding you can specify an optional transformation by using one of the following tags as a child of a <code>&lt;bind /&gt;</code> elements:
 * </p>
 * <ul>
 * <li><code>&lt;map /&gt;</code>: Maps a constant string to a string or a resource. Use one instance of this tag per value you want to map</li>
 * <li><code>&lt;transform /&gt;</code>: Transforms a column's value using an expression or an instance of {@link Adapters.CursorTransformation}</li>
 * </ul>
 * <p>
 * While several <code>&lt;map /&gt;</code> tags can be used at the same time, you cannot mix <code>&lt;map /&gt;</code> and <code>&lt;transform /&gt;</code> tags. If several
 * <code>&lt;transform /&gt;</code> tags are specified, only the last one is retained.
 * </p>
 * 
 ...
 * </p>
 * <p>
 * A map element simply specifies a value to match from and a value to match to. When a column's value equals the value to match from, it is replaced with the value to match to.
 * The following attributes are supported:
 * </p>
 * <ul>
 * <li><code>android:fromValue</code>: The value to match from. This attribute is mandatory</li>
 * <li><code>android:toValue</code>: The value to match to. This value can be either a string or a resource identifier. This value is interpreted as a resource identifier when the
 ...
 * </p>
 * <ul>
 * <li><code>android:withExpression</code>: The transformation expression. The expression is a string containing column names surrounded with curly braces { and }. During the
 * transformation each column name is replaced by its value. All columns must have been selected in the query. An example of expression is <code>"First name: {first_name},
 *  last name: {last_name}"</code>. This attribute is mandatory if <code>android:withClass</code> is not specified and ignored if <code>android:withClass</code> is specified</li>
 * <li><code>android:withClass</code>: A fully qualified class name corresponding to an implementation of {@link Adapters.CursorTransformation}. Custom transformations cannot be
 * used with {@link android.content.Context#isRestricted() restricted contexts}, for instance in an app widget This attribute is mandatory if <code>android:withExpression</code> is
 * not specified</li>
 * </ul>
 * 
 * <h3>Example</h3>
 * <p>
 * The following example defines a cursor adapter that queries all the contacts with a phone number using the contacts content provider. Each contact is displayed with its display
 * name, its favorite status and its photo. To display photos, a custom data binder is declared:
 * </p>
 * 
 ...
 * 
 *      attr ref android.R.styleable#CursorAdapter_layout attr ref android.R.styleable#CursorAdapter_selection attr ref android.R.styleable#CursorAdapter_sortOrder attr ref
 *      android.R.styleable#CursorAdapter_uri attr ref android.R.styleable#CursorAdapter_BindItem_as attr ref android.R.styleable#CursorAdapter_BindItem_from attr ref
 *      android.R.styleable#CursorAdapter_BindItem_to attr ref android.R.styleable#CursorAdapter_MapItem_fromValue attr ref android.R.styleable#CursorAdapter_MapItem_toValue attr
 *      ref android.R.styleable#CursorAdapter_SelectItem_column attr ref android.R.styleable#CursorAdapter_TransformItem_withClass attr ref
...
public class Adapters {
	...
	/**
	 * <p>
	 * Interface used to bind a {@link android.database.Cursor} column to a View. This interface can be used to provide bindings for data types not supported by the standard
	 * implementation of {@link Adapters}.
	 * </p>
	 * 
	 * <p>
	 * A binder is provided with a cursor transformation which may or may not be used to transform the value retrieved from the cursor. The transformation is guaranteed to never be
	 * null so it's always safe to apply the transformation.
	 * </p>
	 * 
	 * <p>
	...
	public static abstract class CursorBinder {
		...
		/**
		 * <p>
		 * The transformation associated with this binder. This transformation is never null and may or may not be applied to the Cursor data during the
		 ...
		 *            The transformation associated with this binder. This transformation may or may not be applied by the binder and is guaranteed to not be null.
		 */
		...
		/**
		 * <p>
		 * Binds the specified Cursor column to the supplied View. The binding operation can query other Cursor columns as needed. During the binding operation, values retrieved
		 * from the Cursor may or may not be transformed using this binder's cursor transformation.
		 * </p>
		 * 
		 * @param view
		 ...
		 * @param columnIndex
		 *            The column index in the cursor where the data to bind resides.
		 * 
		 * @see #mTransformation
		 * 
	 ...
	 * 
	 * <p>
	 * Transformations are used to transform text-based data (in the form of a String), or to transform data into a resource identifier. A default implementation is provided to
	...
	public static abstract class CursorTransformation {
		...
		/**
		 * <p>
		 * Transforms the specified Cursor column into a String. The transformation can simply return the content of the column as a String (this is known as the identity
		 * transformation) or manipulate the content. For instance, a transformation can perform text substitutions or concatenate other columns with the specified column.
		 * </p>
		 * 
		 * @param cursor
	...
	/**
	 * <p>
	 * Loads the {@link android.widget.CursorAdapter} defined in the specified XML resource. The content of the adapter is loaded from the content provider identified by the
	 * supplied URI.
	 * </p>
	 * 
	 * <p>
	 * <strong>Note:</strong> If the supplied {@link android.content.Context} is an {@link android.app.Activity}, the cursor returned by the content provider will be automatically
	 * managed. Otherwise, you are responsible for managing the cursor yourself.
	 * </p>
	 * 
	 * <p>
	 ...
	 * @param parameters
	 *            Optional parameters to pass to the CursorAdapter, used to substitute values in the selection expression.
	 * 
	 * @return A {@link android.widget.CursorAdapter}
	 * 
	 * @throws IllegalArgumentException
	 *             If the XML resource does not contain a valid &lt;cursor-adapter /&gt; definition.
	 * 
	 * @see android.content.ContentProvider
	...
	public static CursorAdapter loadCursorAdapter(Context context, int id, String uri, Object... parameters) {
		...
		if (uri != null) adapter.setUri(uri);
		adapter.load();
		return adapter;
	}
	...
	/**
	 * <p>
	 * Loads the {@link android.widget.CursorAdapter} defined in the specified XML resource. The content of the adapter is loaded from the specified cursor. You are responsible for
	 * managing the supplied cursor.
	 * </p>
	 * 
	 * <p>
	 * The format of the XML definition of the cursor adapter is documented at the top of this page.
	...
	public static CursorAdapter loadCursorAdapter(Context context, int id, Cursor cursor, Object... parameters) {
		XmlCursorAdapter adapter = (XmlCursorAdapter) loadAdapter(context, id, ADAPTER_CURSOR, parameters);
		if (cursor != null) adapter.changeCursor(cursor);
		return adapter;
	}

	/**
	 * <p>
	 * Loads the adapter defined in the specified XML resource. The XML definition of the adapter must follow the format definition of one of the supported adapter types described
	 * at the top of this page.
	 * </p>
	 * 
	 * <p>
	 * <strong>Note:</strong> If the loaded adapter is a {@link android.widget.CursorAdapter} and the supplied {@link android.content.Context} is an {@link android.app.Activity},
	 * the cursor returned by the content provider will be automatically managed. Otherwise, you are responsible for managing the cursor yourself.
	 * </p>
	 * 
	 * @param context
	 *            The context to load the XML resource from.
	...
	/**
	 * Loads an adapter from the specified XML resource. The optional assertName can be used to exit early if the adapter defined in the XML resource is not of the expected type.
	 * 
	 * @param context
	 *            The context to associate with the adapter.
	 * @param id
	 *            The resource id of the XML document defining the adapter.
	 * @param assertName
	 *            The mandatory name of the adapter in the XML document. Ignored if null.
	 * @param parameters
	...
	/**
	 * Generates an adapter using the specified XML parser. This method is responsible for choosing the type of the adapter to create based on the content of the XML parser.
	 * 
	 * This method will generate an {@link IllegalArgumentException} if <code>assertName</code> is not null and does not match the root tag of the XML document.
	 */
	private static BaseAdapter createAdapterFromXml(Context c, XmlPullParser parser, AttributeSet attrs, int id, Object[] parameters,
		...
		while (((type = parser.next()) != XmlPullParser.END_TAG || parser.getDepth() > depth) && type != XmlPullParser.END_DOCUMENT) {
			...
			if (assertName != null && !assertName.equals(name)) {
				throw new IllegalArgumentException("The adapter defined in " + c.getResources().getResourceEntryName(id) + " must be a <"
						+ assertName + " />");
			}
	 ...
	 */
	private static XmlCursorAdapter createCursorAdapter(Context c, XmlPullParser parser, AttributeSet attrs, int id, Object[] parameters)
			throws IOException, XmlPullParserException {
		return new XmlCursorAdapterParser(c, parser, attrs, id).parse(parameters);
	}

	/**
	 * Parser that can generate XmlCursorAdapter instances. This parser is responsible for handling all the attributes and child nodes for a &lt;cursor-adapter /&gt;.
	 */
	private static class XmlCursorAdapterParser {
		...
		private void parseSelectTag() {
			TypedArray a = mResources.obtainAttributes(mAttrs, R.styleable.CursorAdapter_SelectItem);

			String fromName = a.getString(R.styleable.CursorAdapter_SelectItem_column);
			if (fromName == null) {
				throw new IllegalArgumentException("A select item in " + mResources.getResourceEntryName(mId) + " does not have a 'column' attribute");
			}
		...
		private void parseBindTag() throws IOException, XmlPullParserException {
			Resources resources = mResources;
			TypedArray a = resources.obtainAttributes(mAttrs, R.styleable.CursorAdapter_BindItem);

			String fromName = a.getString(R.styleable.CursorAdapter_BindItem_from);
			if (fromName == null) {
				throw new IllegalArgumentException("A bind item in " + resources.getResourceEntryName(mId) + " does not have a 'from' attribute");
			}

			int toName = a.getResourceId(R.styleable.CursorAdapter_BindItem_to, 0);
			if (toName == 0) {
				throw new IllegalArgumentException("A bind item in " + resources.getResourceEntryName(mId) + " does not have a 'to' attribute");
			}

			String asType = a.getString(R.styleable.CursorAdapter_BindItem_as);
			if (asType == null) {
				throw new IllegalArgumentException("A bind item in " + resources.getResourceEntryName(mId) + " does not have an 'as' attribute");
			}
		...
		private CursorBinder createBinder(String type, CursorTransformation transformation) {
			...
			try {
				...
				throw new IllegalArgumentException("Cannot instanciate binder type in " + mContext.getResources().getResourceEntryName(mId) + ": "
						+ type, e);
		...
		private void findMap(MapTransformation transformation, boolean drawable) {
			...
			TypedArray a = resources.obtainAttributes(mAttrs, R.styleable.CursorAdapter_MapItem);

			String from = a.getString(R.styleable.CursorAdapter_MapItem_fromValue);
			if (from == null) {
				throw new IllegalArgumentException("A map item in " + resources.getResourceEntryName(mId) + " does not have a 'fromValue' attribute");
			}

			if (!drawable) {
				String to = a.getString(R.styleable.CursorAdapter_MapItem_toValue);
				if (to == null) {
					throw new IllegalArgumentException("A map item in " + resources.getResourceEntryName(mId)
		...
		private CursorTransformation findTransformation() {
			...
			TypedArray a = resources.obtainAttributes(mAttrs, R.styleable.CursorAdapter_TransformItem);

			String className = a.getString(R.styleable.CursorAdapter_TransformItem_withClass);
			if (className == null) {
				String expression = a.getString(R.styleable.CursorAdapter_TransformItem_withExpression);
				...
				try {
					...
					throw new IllegalArgumentException("Cannot instanciate transform type in " + mContext.getResources().getResourceEntryName(mId)
							+ ": " + className, e);
				} catch (NoSuchMethodException e) {
					throw new IllegalArgumentException("Cannot instanciate transform type in " + mContext.getResources().getResourceEntryName(mId)
							+ ": " + className, e);
			...
			if (transformation == null) {
				throw new IllegalArgumentException("A transform item in " + resources.getResourceEntryName(mId) + " must have a 'withClass' or "
	...
	/**
	 * Implementation of a Cursor adapter defined in XML. This class is a thin wrapper of a SimpleCursorAdapter. The main difference is the ability to handle CursorBinders.
	 */
	private static class XmlCursorAdapter extends SimpleCursorAdapter implements ManagedAdapter {
		...
		XmlCursorAdapter(Context context, int layout, String uri, String[] from, int[] to, String selection, String[] selectionArgs,
				String sortOrder, HashMap<String, CursorBinder> binders) {
		...
		class QueryTask extends AsyncTask<Void, Void, Cursor> {
			...
			protected Cursor doInBackground(Void... params) {
				if (mContext instanceof Activity) {
					return ((Activity) mContext).managedQuery(Uri.parse(mUri), mColumns, mSelection, mSelectionArgs, mSortOrder);
				} else {
					return mContext.getContentResolver().query(Uri.parse(mUri), mColumns, mSelection, mSelectionArgs, mSortOrder);
				}
			}
	...
	/**
	 * Identity transformation, returns the content of the specified column as a String, without performing any manipulation. This is used when no transformation is specified.
	 */
	...
	/**
	 * An expression transformation is a simple template based replacement utility. In an expression, each segment of the form <code>{([^}]+)}</code> is replaced with the value of
	 * the column of name $1.
	 */
	...
	/**
	 * A map transformation offers a simple mapping between specified String values to Strings or integers.
	 */
