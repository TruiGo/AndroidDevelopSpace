...
/**
 * Simple fragment containing only a TextView. Used by TextPagerAdapter to create tutorial-style pages for apps.
 */
public class SimpleTextFragment extends Fragment {
	 ...
	 * 
	 * @param stringId
	 *            A resource ID representing the text content for this Fragment's TextView.
	 */
