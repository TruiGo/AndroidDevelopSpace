 ...
 */
public class CardEmulationSample extends SampleActivityBase {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_car_emulation);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		getMenuInflater().inflate(R.menu.car_emulation, menu);
		return true;
	}
