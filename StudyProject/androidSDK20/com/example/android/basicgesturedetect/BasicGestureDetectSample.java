 ...
 */
public class BasicGestureDetectSample extends SampleActivityBase {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		tv.setText("Welcome to Basic Gesture Detect! In order to try this sample out, try dragging or tapping this text to see what happens!");
	}
