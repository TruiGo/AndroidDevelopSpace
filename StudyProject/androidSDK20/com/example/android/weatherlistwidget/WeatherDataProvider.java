...
/**
 * A dummy class that we are going to use internally to store weather data. Generally, this data will be stored in an external and persistent location (ie. File, Database,
 * SharedPreferences) so that the data can persist if the process is ever killed. For simplicity, in this sample the data will only be stored in memory.
 */
...
public class WeatherDataProvider extends ContentProvider {
	...
	/**
	 * Generally, this data will be stored in an external and persistent location (ie. File, Database, SharedPreferences) so that the data can persist if the process is ever
	 * killed. For simplicity, in this sample the data will only be stored in memory.
	 */
	...
	public synchronized Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
		...
		final MatrixCursor c = new MatrixCursor(new String[] { Columns.ID, Columns.DAY, Columns.TEMPERATURE });
