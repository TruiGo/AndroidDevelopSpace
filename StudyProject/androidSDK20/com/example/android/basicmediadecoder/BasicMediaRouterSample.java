 ...
 * </p>
 * <p>
 * The activity uses the {@link android.media.MediaRouter} API to automatically detect when a presentation display is available and to allow the user to control the media routes
 * using a menu item provided by the {@link android.app.MediaRouteActionProvider}. When a presentation display is available a {@link android.app.Presentation} (implemented as a
 * {@link SamplePresentation}) is shown on the preferred display. A button toggles the background color of the secondary screen to show the interaction between the primary and
 * secondary screens.
 * </p>
 * <p>
 ...
 */
public class BasicMediaRouterSample extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_mediarouter);
		...
		tv.setText("This sample demonstrates the use of the MediaRouter API to display content on a secondary display.\n\nUse the \"Media Route Action Item\" in the ActionBar to select an output device. If your device supports Miracast wireless displays, you may need to enable \"Wireless Display\" functionality in the system settings.Secondary screen simulation can also be enabled from the \"Developer Options\".\n\nOnce connected, use the \"Change Color\" button to change the background color of the secondary screen.");
	}

	/**
	 * Implementing a {@link android.media.MediaRouter.Callback} to update the displayed {@link android.app.Presentation} when a route is selected, unselected or the presentation
	 * display has changed. The provided stub implementation {@link android.media.MediaRouter.SimpleCallback} is extended and only
	 ...
	 * {@link android.media.MediaRouter.SimpleCallback#onRouteUnselected(android.media.MediaRouter, int, android.media.MediaRouter.RouteInfo)} and
	 * {@link android.media.MediaRouter.SimpleCallback#onRoutePresentationDisplayChanged(android.media.MediaRouter, android.media.MediaRouter.RouteInfo)} are overridden to update
	 * the displayed {@link android.app.Presentation} in {@link #updatePresentation()}. These callbacks enable or disable the second screen presentation based on the routing
	 * provided by the {@link android.media.MediaRouter} for {@link android.media.MediaRouter#ROUTE_TYPE_LIVE_VIDEO} streams. @
	 */
	...
	/**
	 * Updates the displayed presentation to enable a secondary screen if it has been selected in the {@link android.media.MediaRouter} for the
	 * {@link android.media.MediaRouter#ROUTE_TYPE_LIVE_VIDEO} type. If no screen has been selected by the {@link android.media.MediaRouter}, the current screen is disabled.
	 * Otherwise a new {@link SamplePresentation} is initialized and shown on the secondary screen.
	 */
	private void updatePresentation() {
		...
		/*
		 * Dismiss the current presentation if the display has changed or no new route has been selected
		 */
		...
		if (mPresentation == null && selectedDisplay != null) {
			...
			try {
				mPresentation.show();
				mTextStatus.setText(getResources().getString(R.string.secondary_connected, selectedRoute.getName(BasicMediaRouterSample.this)));
	...
	/**
	 * Inflates the ActionBar or options menu. The menu file defines an item for the {@link android.app.MediaRouteActionProvider}, which is registered here for all live video
	 * devices using {@link android.media.MediaRouter#ROUTE_TYPE_LIVE_VIDEO}.
	 */
	@Override
	public boolean onCreateOptionsMenu(Menu menu) {
		super.onCreateOptionsMenu(menu);

		getMenuInflater().inflate(R.menu.menu_mediarouter, menu);
