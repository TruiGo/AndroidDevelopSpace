...
/**
 * Abstraction of common playback operations of media items, such as play, seek, etc. Used by PlaybackManager as a backend to handle actual playback of media items.
 */
public abstract class Player {
	...
	public static Player create(Context context, RouteInfo route) {
		Player player;
		if (route != null && route.supportsControlCategory(MediaControlIntent.CATEGORY_REMOTE_PLAYBACK)) {
