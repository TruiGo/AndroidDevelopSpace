...
public class CameraHelper {
	...
	/**
	 * Iterate over supported camera preview sizes to see which one best fits the dimensions of the given view while maintaining the aspect ratio. If none can, be lenient with the
	 * aspect ratio.
	 * 
	 * @param sizes
	...
	/**
	 * Creates a media file in the {@code Environment.DIRECTORY_PICTURES} directory. The directory is persistent and available to other applications like gallery.
	 * 
	 * @param type
