...
public abstract class OverlayDisplayWindow {
	...
	protected OverlayDisplayWindow(Context context, String name, int width, int height, int gravity) {
		mContext = context;
		mName = name;
		mWidth = width;
		mHeight = height;
	...
	public static OverlayDisplayWindow create(Context context, String name, int width, int height, int gravity) {
	...
	private static final class LegacyImpl extends OverlayDisplayWindow {
		...
		public LegacyImpl(Context context, String name, int width, int height, int gravity) {
	...
	private static final class JellybeanMr1Impl extends OverlayDisplayWindow {
		...
		public JellybeanMr1Impl(Context context, String name, int width, int height, int gravity) {
			super(context, name, width, height, gravity);
		...
		private void createWindow() {
			...
			mWindowParams.flags |= WindowManager.LayoutParams.FLAG_LAYOUT_IN_SCREEN | WindowManager.LayoutParams.FLAG_LAYOUT_NO_LIMITS
					| WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE | WindowManager.LayoutParams.FLAG_NOT_TOUCH_MODAL
		...
		private void updateWindowParams() {
			...
			if (DEBUG) {
				Log.d(TAG, "updateWindowParams: scale=" + scale + ", offsetScale=" + offsetScale + ", x=" + x + ", y=" + y + ", width=" + width
						+ ", height=" + height);
			}
			...
			mTextureView.setTranslationX((mWidth - mTextureView.getLayoutParams().width) * scale / 2);
			mTextureView.setTranslationY((mHeight - mTextureView.getLayoutParams().height) * scale / 2);
