 ...
 */
public abstract class LocalPlayer extends Player implements MediaPlayer.OnPreparedListener, MediaPlayer.OnCompletionListener,
	...
	protected void updateSurface() {
		...
		if (mSurface != null) {
			...
			if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
				...
				throw new UnsupportedOperationException("MediaPlayer does not support " + "setSurface() on this version of the platform.");
			}
	...
	/**
	 * Handles playback of a single media item using MediaPlayer in OverlayDisplayWindow.
	 */
	public static class OverlayPlayer extends LocalPlayer implements OverlayDisplayWindow.OverlayWindowListener {
		...
		public OverlayPlayer(Context context) {
			...
			mOverlay = OverlayDisplayWindow.create(getContext(), getContext().getResources().getString(R.string.sample_media_route_provider_remote),
