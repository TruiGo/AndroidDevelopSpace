...
/**
 * This activity uses a {@link android.view.TextureView} to render the frames of a video decoded using {@link android.media.MediaCodec} API.
 */
public class BasicMediaDecoderSample extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_basemediadecoder);
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		inflater.inflate(R.menu.menu_basemediadecoder, menu);
		return true;
	}
