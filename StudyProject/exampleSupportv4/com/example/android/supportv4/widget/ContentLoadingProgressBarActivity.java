 ...
 * button is pressed.
 */
public class ContentLoadingProgressBarActivity extends Activity implements OnClickListener,
	...
	public void onGlobalLayout() {
		...
		if (mLastVisibility != visibility) {
			if (visibility == View.VISIBLE) {
				...
				mShowTextDone.setText("Shown at " + (mVisibilityChangedTime - mShowTime));
			} else {
				mHideTextDone.setText("Hidden after " + (System.currentTimeMillis() - mVisibilityChangedTime));
			}
			mLastVisibility = mBar.getVisibility();
		}
	}
