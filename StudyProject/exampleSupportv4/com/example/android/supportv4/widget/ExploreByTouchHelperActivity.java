...
public class ExploreByTouchHelperActivity extends Activity {
	...
	public static class CustomView extends View {
		 ...
		 * @param top
		 *            Top coordinate as a fraction of the parent height, range
		 *            is [0,1].
		 * @param left
		 *            Left coordinate as a fraction of the parent width, range
		 *            is [0,1].
		 * @param bottom
		 *            Bottom coordinate as a fraction of the parent height,
		 *            range is [0,1].
		 * @param right
		 *            Right coordinate as a fraction of the parent width, range
		 *            is [0,1].
		 */
