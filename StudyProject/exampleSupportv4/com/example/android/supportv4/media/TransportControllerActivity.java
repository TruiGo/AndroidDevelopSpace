...
public class TransportControllerActivity extends Activity {
	...
	TransportPerformer mTransportPerformer = new TransportPerformer() {
		...
		public int onGetTransportControlFlags() {
			int flags = TransportMediator.FLAG_KEY_MEDIA_PLAY | TransportMediator.FLAG_KEY_MEDIA_PLAY_PAUSE
	 ...
	 */
	public static class Content extends VideoView implements View.OnSystemUiVisibilityChangeListener,
			View.OnClickListener, ActionBar.OnMenuVisibilityListener, MediaPlayer.OnPreparedListener,
		...
		void setNavVisibility(boolean visible) {
			int newVis = SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN | SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
	...
	public void onCreate(Bundle icicle) {
		...
		mContent.setVideoURI(Uri.parse("android.resource://" + getPackageName() + "/" + R.raw.videoviewdemo));
	}

	@Override
	public boolean dispatchKeyEvent(KeyEvent event) {
		// We first dispatch keys to the transport controller -- we want it
		// to get to consume any media keys rather than letting whoever has
		// focus
