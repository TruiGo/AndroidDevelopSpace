...
public class SimpleWakefulController extends Activity {
	...
	private View.OnClickListener mScheduleListener = new View.OnClickListener() {
		public void onClick(View v) {
			...
			PendingIntent sender = PendingIntent.getBroadcast(SimpleWakefulController.this, 0, intent, 0);
			...
			mToast = Toast.makeText(SimpleWakefulController.this, R.string.simple_wakeful_scheduled, Toast.LENGTH_LONG);
			mToast.show();
		}
	};
}
