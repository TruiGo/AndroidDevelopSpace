...
/**
 * This example shows a simple way to handle data shared with your app through
 * the use of the support library's ShareCompat features. It will display shared
 * text content as well as the application label and icon of the app that shared
 * the content.
 */
public class SharingReceiverSupport extends Activity {
	...
	protected void onCreate(Bundle b) {
		...
		// The following provides attribution for the app that shared the data
		// with us.
		...
		for (int i = 0; i < N; i++) {
			...
			try {
				BufferedReader reader = new BufferedReader(new InputStreamReader(getContentResolver().openInputStream(
						uri)));
				try {
