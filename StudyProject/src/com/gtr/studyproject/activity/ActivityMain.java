	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		findViewById(R.id.dummy_button).setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				String frameac = "com.gtr.studyproject.activity.ActivityFramelayout";
				String surfaceac = "com.gtr.studyproject.activity.ActivitySurfaceView";
				intent.setClassName(ActivityMain.this, surfaceac);
