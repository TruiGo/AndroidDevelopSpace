...
/**
 * A sample implementation of a {@link RecognitionService}. This very simple implementation does no actual voice recognition. It just immediately returns fake recognition results.
 * Depending on the setting chosen in {@link VoiceRecognitionSettings}, it either returns a list of letters ("a", "b", "c"), or a list of numbers ("1", "2", "3").
 */
public class VoiceRecognitionService extends RecognitionService {
	...
	protected void onStartListening(Intent recognizerIntent, Callback listener) {
		...
		SharedPreferences prefs = getSharedPreferences(VoiceRecognitionSettings.SHARED_PREFERENCES_NAME, Context.MODE_PRIVATE);

		String resultType = prefs.getString(VoiceRecognitionSettings.PREF_KEY_RESULTS_TYPE,
