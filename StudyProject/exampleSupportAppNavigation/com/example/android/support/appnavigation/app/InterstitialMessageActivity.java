...
public class InterstitialMessageActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Mylog.info("############################################# onCreate InterstitialMessageActivity");
	...
	public void onViewContent(View v) {
		TaskStackBuilder
				...
				.addNextIntent(
						new Intent(this, ContentViewActivity.class).putExtra(ContentViewActivity.EXTRA_TEXT,
								"From Interstitial Notification")).startActivities();
		finish();
	}
}
