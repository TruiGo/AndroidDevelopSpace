...
import com.gtr.studyproject.activity.BuildConfig;
...
/**
 * The main fragment that powers the ImageGridActivity screen. Fairly straight forward GridView implementation with the key addition being the ImageWorker class w/ImageCache to
 * load children asynchronously, keeping the UI nice and smooth and caching thumbnails for quick retrieval. The cache is retained over configuration changes like orientation change
...
public class ImageGridFragment extends Fragment implements AdapterView.OnItemClickListener {
	...
	private ImageWorkerResizerFetcher mImageFetcher;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		mImageFetcher = new ImageWorkerResizerFetcher(getActivity(), mImageThumbSize);
	...
	/**
	 * The main adapter that backs the GridView. This is fairly standard except the number of columns in the GridView is used to create a fake top row of empty views as we use a
